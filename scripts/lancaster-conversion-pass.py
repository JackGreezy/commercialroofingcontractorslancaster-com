...
<section class="rr-lc-markets"><div class="rr-lc-shell"><div class="rr-lc-market-grid"><div><p class="rr-lc-kicker">Lancaster County Coverage</p><h2>Commercial roofs across the city, county, and Susquehanna Valley.</h2><p>We help owners and facility teams responsible for warehouses, manufacturing plants, retail centers, schools, healthcare properties, offices, hospitality buildings, and multi-site portfolios.</p><div class="rr-lc-actions"><a class="rr-lc-btn" href="/locations">View service areas</a><a class="rr-lc-btn rr-lc-btn--light" style="border-color:#0666bb;color:#0666bb!important" href="/contact">Start a roof request</a></div></div><div class="rr-lc-market-list"><a href="/locations/downtown-lancaster">Downtown Lancaster</a><a href="/locations/manheim-township">Manheim Township</a><a href="/locations/lititz">Lititz</a><a href="/locations/ephrata">Ephrata</a><a href="/locations/columbia">Columbia</a><a href="/locations/mount-joy">Mount Joy</a><a href="/locations/new-holland">New Holland</a><a href="/locations/willow-street">Willow Street</a></div></div></div></section>
